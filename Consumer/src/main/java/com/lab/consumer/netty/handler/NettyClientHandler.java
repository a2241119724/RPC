package com.lab.consumer.netty.handler;
...
import com.lab.consumer.netty.ServerCallAop;
...
public class NettyClientHandler extends SimpleChannelInboundHandler<String> implements BeanPostProcessor{
    ...
    @Resource
    private ServerCallAop serverCallAop;
                ...
                case JDK:
                    serverProxy = Proxy.newProxyInstance(serverClass.getClassLoader(), new Class[]{serverClass},
                        (Object proxy, Method method, Object[] args) -> {
                            return serverCallAop.intercept(proxy, method, args, null);
                        });
                case Cglib:
                    Enhancer enhancer = new Enhancer();
                    enhancer.setSuperclass(serverClass);
                    enhancer.setCallback(serverCallAop);
